...
#docker stop bpmOnJboss; docker rm bpmOnJboss; docker run -i -t -p 8080:8080 -p 9990:9990 -p 9999:9999 --link rhbpmsOracle:oracleHost --name "bpmOnJboss" docker-bpm-on-jbosseap-base /bin/bash
